...
imageUrl: "/images/projects/university.png"
...
#### TL;DR
The analysis showed that **data-driven playstyle profiles meaningfully align with expert role labels** while also revealing fluidity and overlap in how roles manifest. To achieve this, I designed a bespoke workflow to process ~400GB of raw match data, engineered **custom features**, and applied a mix of **EDA**, **linear regression**, **logistic regression/random forest**, and multiple **clustering methods** with quality metrics (**Silhouette, Calinski–Harabasz, NMI, ARI**).

**Tags:** Machine Learning · Python · Data Visualisation · Feature Engineering · SQL
