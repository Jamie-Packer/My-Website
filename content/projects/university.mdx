...
This module was designed as an entry-level introduction for MSc students and final year computer science undergraduates, so the assignment was relatively simple.
